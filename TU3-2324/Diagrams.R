...
add_mathjax(
  ...
  "digraph flowchart {
      ...
      tab5 -> tab7 [label = 'Margin of Error', fontcolor = red, fontsize = 8, color = red]
      tab7 -> tab10 [label = 'Confidence Interval', fontcolor = green, fontsize = 8, color = green]

      tab6 -> tab8 [label = 'Margin of Error', fontcolor = red, fontsize = 8, color = red]
      tab8 -> tab11 [label = 'Confidence Interval', fontcolor = green, fontsize = 8, color = green]

      tab3 -> tab9 [label = 'Margin of Error', fontcolor = red, fontsize = 8, color = red]
      tab9 -> tab12 [label = 'Confidence Interval', fontcolor = green, fontsize = 8, color = green]
...
add_mathjax(
  grViz(
    "digraph flowchart {
      ...
      # node definitions with substituted label text
      node [fontname = Helvetica, shape = box, fixedsize = true, width = 1.6]
      tab1 [label = 'Confidence \n Intervals', style = filled, fillcolor = lightblue]
      tab2 [label = 'Population \n Mean']
